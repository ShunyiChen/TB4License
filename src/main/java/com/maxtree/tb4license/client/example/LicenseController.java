 ...
 *
 * This class is the "license controller" class for my Hyde software application.
 * It uses the True License Java license manager framework to help license my
 * software application.
 *
 * Besides using the True License license manager, this class was also responsible
 * for installing hidden "cookie" files on the user's computer so I could tell
 * whether they had installed the app using a "Free Trial Period" before.
 * This is done because if you only store usage information in Java Preferences,
 * that information can easily be deleted by the user, especially on a Mac system.
 *
 * This class is essentially used by the main() method of my application, something
 * like this:
 *
...
//  
//  // this is a cheesy way to see if the app has been used before with a free trial period.
//  // serialize the DateInfo class to these two files; use these as a check to see if the app
...
//  
//  /**
//   * Let other classes access the error message, to make their messages
//   * to the user better.
//   */
...
//      {
//        // this is the method that is called so we can put "cookies" on the user's
...
//   * get the filename, then try to install the file.
//   * 
